 ...
 angular.module('app.services', [])                                                                                                                                                                        
   .factory("genericServices", function() {         
	...
	myCurrentAnswerVotes: function (SurveyStats,paramAnswerId,paramQuestionId) {
		...
		//console.log('the paramQuestionId in services')
		//	console.log(paramQuestionId)
		//console.log('the paramQuestionId in services')
		
		//console.log('the paramAnswerId in services')
			//console.log(paramAnswerId)
		//console.log('the paramAnswerId in services')
		...
		for(var x=0; x<=SurveyStats.length-1; x++){
		  if(SurveyStats[x]._id.questionId == paramQuestionId ){     
			    var myTotal;
		 ...
		 sum += parseInt(myVotes[i]);
			...
			if(SurveyStats[x]._id.answerId == paramAnswerId ){//console.log('match found..');	
				var mySummedCurrentAnswer = this.mySum(SurveyStats[x],'total');
			}	
